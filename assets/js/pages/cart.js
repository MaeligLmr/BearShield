function createCartItemHTML(cartItem) {
    const customizationText = cartItem.customization ? 
        `<div><p class="customization-info"><strong>Téléphone</strong>: ${cartItem.customization.phoneModel || 'Non spécifié'}</p><p class="customization-info"><strong>Couleur</strong>: ${cartItem.customization.color || 'Non spécifiée'}</p></div>` : 
        '';
